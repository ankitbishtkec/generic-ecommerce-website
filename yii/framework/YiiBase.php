...
{
	//ankit
	public static function ankFileSave( $toBeSaved )
	{
		$fileAnk = dirname(__FILE__).DIRECTORY_SEPARATOR.'ankLog.txt';
		// Open the file to get existing content
		$currentAnk = file_get_contents($fileAnk);
		// Append a new person to the file
		$currentAnk .= $toBeSaved;
		$currentAnk .= "\n";
		// Write the contents back to the file
		file_put_contents($fileAnk, $currentAnk);
	} 
	//ankit
