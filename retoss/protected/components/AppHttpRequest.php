<?php
/**
 * AppHttpRequest class file.
 *it is added to make csrf validation token at server side instad of in cookie.
 * @author ankit bisht
 */
 ...
 */
 ...
 //it is added to make csrf validation token at server side instad of in cookie.
class AppHttpRequest extends CHttpRequest
{
	private $_csrfToken;
	...
	public function validateCsrfToken($event)
	{
        ...
        if( in_array( $route, $this->noCsrfValidationRoutes ) ) //skip validation for few inputs
        	return true;
	...
	public function getIsMobileBrowserRequest()
	{
    	$response = false;
