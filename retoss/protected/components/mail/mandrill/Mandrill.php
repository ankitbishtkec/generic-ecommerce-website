...
class Mandrill {
    ...
    public function __construct($apikey=null) {
        ...
        $this->ch = curl_init();
        curl_setopt($this->ch, CURLOPT_SSL_VERIFYHOST, 0);//added for resolving ssl tls certificate issue ankit
		curl_setopt($this->ch, CURLOPT_SSL_VERIFYPEER, 0);//added for resolving  ssl tls certificate issue ankit
