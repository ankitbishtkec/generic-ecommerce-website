...
class Bootstrap extends CApplicationComponent
{
	...
	public function registerCoreCss()
	{
		...
		Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/font-awesome-4.3.0/css/'.'font-awesome.min.css');
	}
	...
	public function registerResponsiveCss()
	{
		...
		//below two line commentd to suppport new bootstrap asset files-ankit
	...
	protected function registerJS($position = CClientScript::POS_HEAD)
	{
		...
		$cs->registerScriptFile($this->getAssetsUrl().'/js/'.'html5shiv.min.js', $position);
		$cs->registerScriptFile($this->getAssetsUrl().'/js/'.'respond.min.js', $position);
